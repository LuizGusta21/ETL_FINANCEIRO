...
def consultar_movimentos(app_key: str, app_secret: str, empresa: str, dtinicio: str = None, dtfim: str = None) -> list:
    ...
    try:
        ...
        log_error("Erro na requisição durante a consulta de movimentos", e, payload, response)
...
def consultar_categorias(app_key: str, app_secret: str, empresa: str) -> list:
    ...
    try:
        ...
        log_error("Erro na requisição durante a consulta de categorias", e, payload, response)
    return all_data
...
def consultar_orcamentos(app_key: str, app_secret: str, empresa: str, ano: int, mes: int) -> list:
    ...
    try:
        ...
        log_error("Erro na requisição durante a consulta de orcamentos", e, payload, response)
